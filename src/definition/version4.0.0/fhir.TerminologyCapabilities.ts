...
// To parse this data:
//
//   import { Convert, FhirTerminologyCapabilities } from "./file";
//
//   const fhirTerminologyCapabilities = Convert.toFhirTerminologyCapabilities(json);
//
 ...
 * content.
 */
export enum FhirTerminologyCapabilitiesStatus {
    Active = "active",
    Draft = "draft",
    Retired = "retired",
    Unknown = "unknown",
