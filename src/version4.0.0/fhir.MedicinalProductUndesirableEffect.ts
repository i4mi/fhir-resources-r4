...
// To parse this data:
//
//   import { Convert, FhirMedicinalProductUndesirableEffect } from "./file";
//
//   const fhirMedicinalProductUndesirableEffect = Convert.toFhirMedicinalProductUndesirableEffect(json);
//
