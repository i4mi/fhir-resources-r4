...
// To parse this data:
//
//   import { Convert, FhirStructureDefinition } from "./file";
//
//   const fhirStructureDefinition = Convert.toFhirStructureDefinition(json);
//
 ...
 * The status of this structure definition. Enables tracking the life-cycle of the content.
 */
export enum FhirStructureDefinitionStatus {
    Active = "active",
    Draft = "draft",
    Retired = "retired",
    Unknown = "unknown",
