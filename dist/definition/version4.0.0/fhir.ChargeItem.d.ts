import { Element, Reference, CodeableConcept, Extension, Identifier, Meta, Annotation, Period, Timing, Money, Quantity, Narrative } from "./fhir._";
 ...
 * The current state of the ChargeItem.
 */
export declare enum FhirChargeItemStatus {
    Aborted = "aborted",
    Billable = "billable",
    Billed = "billed",
