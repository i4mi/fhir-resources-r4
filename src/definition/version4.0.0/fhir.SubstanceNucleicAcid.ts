import { Element,
         ...
         Narrative,
         Attachment,
         Identifier} from "./fhir._";

// To parse this data:
//
//   import { Convert, FhirSubstanceNucleicAcid } from "./file";
//
//   const fhirSubstanceNucleicAcid = Convert.toFhirSubstanceNucleicAcid(json);
//
...
export interface SubstanceNucleicAcid {
     ...
     */
    _areaOfHybridisation?: any[] | boolean | Element | number | number | null | string;
    /**
     ...
     */
    contained?: Array<any[] | boolean | SubstanceNucleicAcid | number | null | string>;
    /**
     ...
     * (TBC).
     */
    oligoNucleotideType?: any[] | boolean | CodeableConcept | number | number | null | string;
    /**
     ...
     * multiple times.
     */
    subunit?: Array<any[] | boolean | SubstanceNucleicAcidSubunit | number | number | null | string>;
    /**
...
export interface SubstanceNucleicAcidSubunit {
     ...
     * would be redundant.
     */
    fivePrime?: any[] | boolean | CodeableConcept | number | number | null | string;
    /**
     ...
     */
    linkage?: Array<any[] | boolean | SubstanceNucleicAcidLinkage | number | number | null | string>;
    /**
     * May be used to represent additional information that is not part of the basic definition
     ...
     */
    sugar?: Array<any[] | boolean | SubstanceNucleicAcidSugar | number | number | null | string>;
    /**
     ...
     * would be redundant.
     */
    threePrime?: any[] | boolean | CodeableConcept | number | number | null | string;
}
...
export interface SubstanceNucleicAcidLinkage {
     ...
     */
    _connectivity?: any[] | boolean | Element | number | number | null | string;
    /**
     * Extensions for name
     */
     ...
     */
    _residueSite?: any[] | boolean | Element | number | number | null | string;
    /**
