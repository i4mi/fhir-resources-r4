...
// To parse this data:
//
//   import { Convert, FhirResearchDefinition } from "./file";
//
//   const fhirResearchDefinition = Convert.toFhirResearchDefinition(json);
//
 ...
 * The status of this research definition. Enables tracking the life-cycle of the content.
 */
export enum FhirResearchDefinitionStatus {
    Active = "active",
    Draft = "draft",
    Retired = "retired",
    Unknown = "unknown",
