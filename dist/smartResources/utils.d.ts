...
*/
export declare function getFullName(name: HumanName | undefined, excludeTitles?: boolean, shortenMiddleNames?: boolean): string;
/**
 ...
 */
export declare function validateResource(resource: Resource, options: ValidatorOptions): Promise<ValidatorResult>;
export declare enum ValidatorResultLevel {
    'FATAL' = "fatal",
    'ERROR' = "error",
    'WARNING' = "warning",
    'OK' = "ok"
