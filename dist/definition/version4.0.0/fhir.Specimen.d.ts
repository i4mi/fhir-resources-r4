import { Element, Identifier, CodeableConcept, Extension, Meta, Annotation, Reference, Narrative, Period, Duration, Quantity } from "./fhir._";
 ...
 * The availability of the specimen.
 */
export declare enum FhirSpecimenStatus {
    Available = "available",
