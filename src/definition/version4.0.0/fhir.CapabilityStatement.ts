...
// To parse this data:
//
//   import { Convert, FhirCapabilityStatement } from "./file";
//
//   const fhirCapabilityStatement = Convert.toFhirCapabilityStatement(json);
//
 ...
 * The status of this capability statement. Enables tracking the life-cycle of the content.
 */
export enum FhirCapabilityStatementStatus {
    Active = "active",
    Draft = "draft",
    Retired = "retired",
    Unknown = "unknown",
