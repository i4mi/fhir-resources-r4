import { Element, ContactDetail, Extension, Identifier, CodeableConcept, Meta, Reference, Narrative, UsageContext, Coding } from "./fhir._";
 ...
 * The direction to use for the assertion.
 */
export declare enum TestScriptAssertDirection {
    Request = "request",
    Response = "response"
}
/**
 ...
 * The status of this test script. Enables tracking the life-cycle of the content.
 */
export declare enum FhirTestScriptStatus {
    Active = "active",
    Draft = "draft",
    Retired = "retired",
    Unknown = "unknown"
