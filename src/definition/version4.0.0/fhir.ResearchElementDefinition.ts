...
// To parse this data:
//
//   import { Convert, FhirResearchElementDefinition } from "./file";
//
//   const fhirResearchElementDefinition = Convert.toFhirResearchElementDefinition(json);
//
 ...
 * Indicates how elements are aggregated within the study effective period.
 */
export enum EffectiveGroupMeasure {
    Mean = "mean",
 ...
 * content.
 */
export enum FhirResearchElementDefinitionStatus {
    Active = "active",
    Draft = "draft",
    Retired = "retired",
    Unknown = "unknown",
 ...
 * The type of research element, a population, an exposure, or an outcome.
 */
export enum FhirResearchElementDefinitionType {
    Exposure = "exposure",
    Outcome = "outcome",
