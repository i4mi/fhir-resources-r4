...
export interface RiskEvidenceSynthesis {
     ...
     */
    contained?: RiskEvidenceSynthesis[];
    /**
     ...
     * content.
     */
    status?: RiskEvidenceSynthesisStatus;
    /**
...
/**
 * The RiskEvidenceSynthesis resource describes the likelihood of an outcome in a population
 * plus exposure state where the risk estimate is derived from a combination of research
 * studies.
 */
 ...
 * content.
 */
export enum RiskEvidenceSynthesisStatus {
    Active = "active",
    Draft = "draft",
    Retired = "retired",
    Unknown = "unknown",
