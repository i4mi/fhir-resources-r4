...
// To parse this data:
//
//   import { Convert, FhirTestReport } from "./file";
//
//   const fhirTestReport = Convert.toFhirTestReport(json);
//
 ...
 * The overall result from the execution of the TestScript.
 */
export enum FhirTestReportResult {
    Fail = "fail",
    Pass = "pass",
    Pending = "pending",
}
 ...
 * The current state of this test report.
 */
export enum FhirTestReportStatus {
    Completed = "completed",
