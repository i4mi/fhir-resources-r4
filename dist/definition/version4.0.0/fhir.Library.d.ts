import { Element, ContactDetail, Attachment, DataRequirement, Period, Extension, Identifier, CodeableConcept, Meta, ParameterDefinition, RelatedArtifact, Reference, Narrative, UsageContext } from "./fhir._";
 ...
 * The status of this library. Enables tracking the life-cycle of the content.
 */
export declare enum FhirLibraryStatus {
    Active = "active",
    Draft = "draft",
    Retired = "retired",
    Unknown = "unknown"
