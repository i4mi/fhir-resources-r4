import { Element, CodeableConcept, ContactDetail, Reference, Extension, Identifier, Meta, Annotation, Period, RelatedArtifact, Narrative } from "./fhir._";
 ...
 * The current state of the study.
 */
export declare enum FhirResearchStudyStatus {
    Active = "active",
