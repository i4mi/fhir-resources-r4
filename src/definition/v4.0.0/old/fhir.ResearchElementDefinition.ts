...
export interface ResearchElementDefinition {
     ...
     */
    contained?: ResearchElementDefinition[];
    /**
     ...
     */
    type?: ResearchElementDefinitionType;
    /**
 ...
 * content.
 */
export enum ResearchElementDefinitionStatus {
    Active = "active",
    Draft = "draft",
    Retired = "retired",
    Unknown = "unknown",
 ...
 * The type of research element, a population, an exposure, or an outcome.
 */
export enum ResearchElementDefinitionType {
    Exposure = "exposure",
    Outcome = "outcome",
