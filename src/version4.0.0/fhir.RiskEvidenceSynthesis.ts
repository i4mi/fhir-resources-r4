...
// To parse this data:
//
//   import { Convert, FhirRiskEvidenceSynthesis } from "./file";
//
//   const fhirRiskEvidenceSynthesis = Convert.toFhirRiskEvidenceSynthesis(json);
//
 ...
 * content.
 */
export enum FhirRiskEvidenceSynthesisStatus {
    Active = "active",
    Draft = "draft",
    Retired = "retired",
    Unknown = "unknown",
