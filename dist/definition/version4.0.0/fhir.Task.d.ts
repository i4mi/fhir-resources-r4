import { Element, Reference, CodeableConcept, Period, Extension, Identifier, Meta, Annotation, Narrative, Address, Age, Attachment, Coding, ContactDetail, ContactPoint, Contributor, Count, DataRequirement, Distance, Dosage, Duration, Expression, HumanName, Money, ParameterDefinition, Quantity, Ratio, RelatedArtifact, SampledData, Signature, Timing, TriggerDefinition, UsageContext, Range } from "./fhir._";
 ...
 * The current status of the task.
 */
export declare enum FhirTaskStatus {
    Accepted = "accepted",
    Cancelled = "cancelled",
    Completed = "completed",
    Draft = "draft",
