import { Element, CodeableConcept, Extension, Identifier, Meta, Reference, Attachment, Narrative, Coding, Period } from "./fhir._";
 ...
 * Indicates the current state of this consent.
 */
export declare enum FhirConsentStatus {
    Active = "active",
    Draft = "draft",
